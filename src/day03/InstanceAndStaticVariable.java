...
public class InstanceAndStaticVariable {
   ...
   InstanceAndStaticVariable abc=new InstanceAndStaticVariable();
   abc.name1="mike";//instance
   abc.name="suzan";//static
      System.out.println(abc.name1);//mike
      System.out.println(abc.name);//suzan

      InstanceAndStaticVariable abc1=new InstanceAndStaticVariable();
      abc1.name1="scott";
      abc1.name="ayse";
      ...
      InstanceAndStaticVariable abc2=new InstanceAndStaticVariable();
